...
export const GET_NEW_PRODUCT_FAILURE = "GET_NEW_PRODUCT_FAILURE";

export const GET_BEST_PRODUCT_REQUEST = "GET_BEST_PRODUCT_REQUEST";
export const GET_BEST_PRODUCT_SUCCESS = "GET_BEST_PRODUCT_SUCCESS";
export const GET_BEST_PRODUCT_FAILURE = "GET_BEST_PRODUCT_FAILURE";