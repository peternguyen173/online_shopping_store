...
export const addItemToCart = (reqData) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post(`${API_BASE_URL}/api/cart/cart-items/add`, reqData.data, config);
...
export const removeCartItem = (reqData) => async (dispatch) => {
    try {
        ...
        await axios.delete(`${API_BASE_URL}/api/cart/cart-items/${reqData.cartItemId}`, config);
